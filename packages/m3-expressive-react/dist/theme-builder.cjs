"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } }// ../../node_modules/@material/material-color-utilities/utils/math_utils.js
function signum(num) {
  if (num < 0) {
    return -1;
  } else if (num === 0) {
...
var DynamicColor = class _DynamicColor {
  ...
  static fromPalette(args) {
    return new _DynamicColor(_nullishCoalesce(args.name, () => ( "")), args.palette, _nullishCoalesce(args.tone, () => ( _DynamicColor.getInitialToneFromBackground(args.background))), _nullishCoalesce(args.isBackground, () => ( false)), args.chromaMultiplier, args.background, args.secondBackground, args.contrastCurve, args.toneDeltaPair);
  }
...
var ToneDeltaPair = class {
  ...
  constructor(roleA, roleB, delta, polarity, stayTogether, constraint) {
    ...
    this.constraint = _nullishCoalesce(constraint, () => ( "exact"));
  }
};
...
var DynamicScheme = class _DynamicScheme {
  ...
  constructor(args) {
    ...
    this.platform = _nullishCoalesce(args.platform, () => ( "phone"));
    this.specVersion = _DynamicScheme.maybeFallbackSpecVersion(_nullishCoalesce(args.specVersion, () => ( "2021")), this.variant);
    this.sourceColorHct = args.sourceColorHct;
    this.primaryPalette = _nullishCoalesce(args.primaryPalette, () => ( getSpec2(this.specVersion).getPrimaryPalette(this.variant, args.sourceColorHct, this.isDark, this.platform, this.contrastLevel)));
    this.secondaryPalette = _nullishCoalesce(args.secondaryPalette, () => ( getSpec2(this.specVersion).getSecondaryPalette(this.variant, args.sourceColorHct, this.isDark, this.platform, this.contrastLevel)));
    this.tertiaryPalette = _nullishCoalesce(args.tertiaryPalette, () => ( getSpec2(this.specVersion).getTertiaryPalette(this.variant, args.sourceColorHct, this.isDark, this.platform, this.contrastLevel)));
    this.neutralPalette = _nullishCoalesce(args.neutralPalette, () => ( getSpec2(this.specVersion).getNeutralPalette(this.variant, args.sourceColorHct, this.isDark, this.platform, this.contrastLevel)));
    this.neutralVariantPalette = _nullishCoalesce(args.neutralVariantPalette, () => ( getSpec2(this.specVersion).getNeutralVariantPalette(this.variant, args.sourceColorHct, this.isDark, this.platform, this.contrastLevel)));
    this.errorPalette = _nullishCoalesce(_nullishCoalesce(args.errorPalette, () => ( getSpec2(this.specVersion).getErrorPalette(this.variant, args.sourceColorHct, this.isDark, this.platform, this.contrastLevel))), () => ( TonalPalette.fromHueAndChroma(25, 84)));
...
exports.clampContrast = clampContrast; exports.generateScheme = generateScheme; exports.normalizeHex = normalizeHex; exports.normalizeVariant = normalizeVariant; exports.schemeRoles = schemeRoles; exports.schemeToCssText = schemeToCssText; exports.schemeToCssVars = schemeToCssVars; exports.variantCatalog = variantCatalog; exports.variantIds = variantIds;
